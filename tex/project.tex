...
\begin{theorem}
  Addition is commutative, i.e. there is a function \mint{lean}{add_comm : }
\end{theorem}
\begin{proof}~
...
It's difficult to read on paper, so I encourage you to copy it into a Lean session. Tactic mode lives between \mintinline{lean}{begin ... end} and is a series of commands, that produce a proof. That is, everything in tactic mode translates into a proof in the normal style, but it's easier to iteratively build a proof in tactic mode.
